...
namespace SitePartage.Controllers
{
    public class CommentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CommentID,ProductID,UserID,Title,Description,Date,Status")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CommentID,ProductID,UserID,Title,Description,Date,Status")] Comment comment)
        {
            if (ModelState.IsValid)
            {
